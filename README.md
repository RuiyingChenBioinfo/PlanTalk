...
Please make sure you have run normalization procedures such as "NormalizeData" and "sctransform" so that PlanTalk can extract the "data" slot from respective assays.
